...
function ProjectText(props: {body: any}) {
    return (
        <div className="pb-[40px] pt-[35px] leading-[21px] rounded-[4px] px-[30px] border border-black text-[10px] 2xl:text-[0.7vw] 3xl:text-[0.6vw] 2xl:leading-[1.2vw] 3xl:leading-[1vw]">
