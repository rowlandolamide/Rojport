...
export default function ProjectCard(props: ProjectCardProps){
    ...
    return <div draggable={false} className="xl:w-[25vw] w-[24vw] xl:min-w-[327px] hover:bg-blue-500  h-fit bg-[#FDFEC0] rounded-[5px] p-[4px] border border-black duration-300">
