...
const DeskTopDesignDisplay = (props: {
  text: ReactNode
  header?: string
  Icon?: string
}) => {
  return (
    <div className=" rounded-[5px] cursor-grab p-[4px] 2xl:p-[0.3vw] pt-0  border border-black bg-[#F2F2F2]">
      <motion.div className="px-[35px] cursor-grab py-[30px] 2xl:py-[2vw] 2xl:px-[2.1vw] font-Ingram text-[11px] leading-[21px] xl:text-[0.7vw] xl:leading-[1.4vw]  ">
        <div className="justify-between cursor-grab items-center flex xl:text-[1.6vw] text-[24px]">
          {' '}
          ...
          <Image
            ...
            height={37}
            alt="smilling face"
            className={`${props.Icon ? '' : 'hidden'} pb-4 xl:w-[2.4vw]`}
            src={props.Icon ? props.Icon : SmilingFace.src}
          ></Image>
        </div>
        {props.text}
      </motion.div>
...
export default function IndexRoute() {
  ...
  const textThree =
    "When I'm not working, I like to watch movies from the 1980s, collect old cameras, and add to my ever-growing collection of toys. I think being creative is a way of life, so I'm always looking for new ideas and ways to express myself."
  const textTwo = (
    <div className="grabb cursor-grab">
      Focus: Motion Design | Art Direction | Web Design | Animation | Brand
      Design{' '}
      <div className="mt-4 grabb cursor-grab">
        Capabilities: Proficient in Cinema 4D, Redshift, Octane, Arnold, X
        Particles, Blender, After Effects, Illustrator, Davinci Resolve, web
        design with Figma
      </div>
    </div>
  )
  const textOne = (
    <div className="grabb cursor-grab">
      I&apos;m Olamide Rowland – a motion design enthusiast and creative
      problem-solver. I thrive on empowering brands, startups, and companies to
      flourish. From collaborating with top studios like Yellow Lab and Funken
      Studio to leading as Creative Director at Brass Bank, each project fuels
      my growth and innovation.{' '}
      <div className="mt-4 grabb cursor-grab">
        let&apos;s collaborate on something Olamide@rojthegoat.com
      </div>
    </div>
  )
  ...
  return (
    <div>
      <div
        ...
        className="xl:block hidden w-[200vw]"
      >
        {/* background Image */}
        <Image
          width={100}
          height={100}
          alt="Horizontal Bg"
          className="w-full  fixed left-0 h-full scale-y-[2] z-30 top-0"
          unoptimized
          src={HorizontalBackground.src}
        ></Image>
        {/* End */}
        <div className="h-full absolute top-0 overflow-hidden w-[200vw] ">
          <div className=" w-full  h-full flex relative items-center  ">
            <div
              ref={ref}
              className="absolute grabb cursor-grab  left-[6.7vw] 2xl:w-[23.9vw] w-[345px] z-30 "
            >
              <DeskTopDesignDisplay text={textOne}></DeskTopDesignDisplay>
            </div>
            <div
              ref={refTwo}
              className="grabb cursor-grab absolute right-[70vw] 2xl:w-[20vw] w-[310px] z-30"
            >
              <DeskTopDesignDisplay
                Icon={SmilingFace.src}
                header="CAPABILITIES"
                text={textTwo}
              ></DeskTopDesignDisplay>
            </div>
            <div
              ref={refThree}
              className="absolute grabb cursor-grab right-[7vw] 2xl:w-[20vw] w-[310px] z-30"
            >
              <DeskTopDesignDisplay
                Icon={SunIcon.src}
                header="BONUS"
            ...
            <div
              ref={refFour}
              className="absolute grabb cursor-grab right-[27.2vw]  z-30"
            >
              <Image
                width={100}
                unoptimized
                height={100}
                alt="Mic"
                className="w-[550px] 2xl:w-[38vw] border border-black rounded-[4px]"
                src={MicDrop.src}
              ></Image>
            </div>
            ...
            <div className=" flex flex-col  xl:text-[13.9vw] 2xl:leading-[7.5vw]  2xl:text-[11vw] absolute left-[41vw]  xl:leading-[10vw]  h-[90vh] top-0  justify-center">
              <span className="font-PPn flex items-center ">
                <Image
                  alt=""
                  width={100}
                  height={100}
                  className="rounded-[10px] h-[80%] w-fit mt-[2.4%] mr-[2%]"
                  src={ProfilePicture.src}
                ></Image>
                <span className="">ROJ’ THE GOAT</span>
              </span>
              <span className="font-PPn font-thin">MOTION DESIGNER</span>
              <span className="font-PPn flex">
                <span className="text-bl mr-[2%]">✨</span>ART DIRECTOR
              </span>
            </div>
      ...
      <div className="xl:hidden sm:pt-[5vw]">
        <div className="px-[20px] sm:px-[10vw]">
          {' '}
          <div className=" overflow-hidden rounded-[4px]">
            ...
            <Image
              ...
              width={100}
              height={100}
              className="w-full rounded-[4px] scale-[1.1]"
              alt="Roj's picyure"
            ></Image>
          </div>
        </div>
        <div className="flex items-center justify-center text-[12vw] text-center flex-col leading-[8.6vw] mt-[20px]">
          {' '}
          <div>
            {' '}
            <span className="font-PPn ">
              ROJ’ THE GOAT{' '}
              <div>
                {' '}
                MOTION DESIGNER <span className="text-bl">✨ </span>
              </div>
              ART DIRECTOR <span className="text-bl"></span>
            </span>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center px-[20px] mt-[40px] gap-y-[30px] w-full text-[14px] max-w-[600px] mx-auto">
          ...
          <Image
            ...
            height={100}
            alt="Mic"
            className="w-full border border-black rounded-[4px] "
            src={MicDrop.src}
          ></Image>
        </div>
      </div>
